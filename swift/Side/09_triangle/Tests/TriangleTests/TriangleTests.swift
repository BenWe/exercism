...
class TriangleTests: XCTestCase {
    let triangleKind = (Equilateral:"Equilateral", Isosceles:"Isosceles", Scalene:"Scalene", ErrorKind:"ErrorKind", Degenerate:"Degenerate")
    ...
    func testTrianglesDegenerate() {
        XCTAssertEqual(triangleKind.Degenerate, Triangle(1, 2, 3).kind)
    }

    func testTrianglesDegenerate2() {
        XCTAssertEqual(triangleKind.Degenerate, Triangle(2, 3, 5).kind)
    }
    ...
    static var allTests: [(String, (TriangleTests) -> () throws -> Void)] {
        return [
            ...
            ("testTrianglesDegenerate", testTrianglesDegenerate),
            ("testTrianglesDegenerate2", testTrianglesDegenerate2),
        ]
    }
}
